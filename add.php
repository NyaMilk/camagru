...
if (isset($_POST['save']) && $_POST['save'] == "Save") {
    $new_src = 'img/' . $_SESSION['name'] . '/' . date('HisdmY') . $_SESSION['name'] . '.png';
    ...
    <div class="container">
        <div class="photo-upload">
            <label class="custom-file-upload">
                ...
                <img src="img/transfer.svg" alt="from computer">
                <p>Upload</p>
            ...
            <label class="custom-file-upload">
                ...
                <img src="img/photo-camera.svg" alt="from camera">
                <p>Camera</p>
        ...
        <div class="photo-upload">
            <label class="custom-file-upload">
                <p>Save</p>
                <img src="img/check.svg" alt="from computer">
            ...
            <label id="discard" class="custom-file-upload">
                <p>Discard</p>
                <img src="img/cancel.svg" alt="from camera">
                <!-- <input id="startbutton" type="button"> -->
            </label>
        </div>
